#!/bin/bash
# Build and Install Zephyrus OS with NVIDIA Support TODO: verify this
...
# Check if running from Zephyrus OS directory TODO: verify this
...
# Install Zephyrus OS with NVIDIA support TODO: verify this

echo "Installing Zephyrus OS with NVIDIA support..."
echo ""

# Rebase to the new image TODO: verify this
sudo rpm-ostree rebase ostree-unverified-image:dir:/var/tmp/zephyrus-nvidia-export

if [ $? -eq 0 ]; then
    echo ""   
    echo "ok Installation staged successfully!"
    echo ""
