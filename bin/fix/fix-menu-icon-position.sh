...
kwriteconfig6 --file plasmashellrc --group "PlasmaViews" --group "Panel 1" --key "offset" --delete 2>/dev/null
kwriteconfig6 --file plasmashellrc --group "PlasmaViews" --group "Panel 1" --key "panelLengthMode" --delete 2>/dev/null
...
kwriteconfig6 --file plasma-org.kde.plasma.desktop-appletsrc --group "Containments" --group "1" --group "Applets" --group "$APPLET_ID" --group "Configuration" --group "General" --key "icon" --delete || true
